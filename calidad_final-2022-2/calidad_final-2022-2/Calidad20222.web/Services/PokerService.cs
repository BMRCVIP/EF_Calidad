...
{   
    ...
    //Se añadio
    public const String ESCALERACOLOR = "ESCALERA DE COLOR";
    ...
    private bool EsEscaleraReal(List<Carta> cartas)
    {
        /* var grouping = cartas.GroupBy(o => o.Palo);
         cartas = cartas.OrderBy(o => o.Numero).ToList();
         if (cartas.ElementAt(0).Numero == 1 && cartas.ElementAt(1).Numero == 10 &&
             cartas.ElementAt(0).Numero == 11 && cartas.ElementAt(0).Numero == 12 &&
             cartas.ElementAt(0).Numero == 13 && grouping.Count() == 1)
             return true;
         return false;*/
